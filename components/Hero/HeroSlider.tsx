...
/**
 * Renders an auto-advancing hero image slider with clickable navigation dots.
 *
 * The slider cycles through a set of slides every 4 seconds, each displaying a title, subtitle, image, and a call-to-action link. Users can manually select a slide using the navigation dots below the slider. The current slide's background gradient and content update dynamically, and the entire slide area links to the slide's destination.
 *
 * @returns The hero slider React component.
 */
